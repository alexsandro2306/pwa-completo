...
const AdminDashboard = () => {
    ...
    const [userTab, setUserTab] = useState('client'); // 'client' or 'trainer'
    ...
    const statCards = [
        ...
        { icon: <UserCheck size={24} />, label: 'Trainers Ativos', value: stats.activeTrainers, color: '#10b981' },
        { icon: <UserX size={24} />, label: 'Trainers Pendentes', value: stats.pendingTrainers, color: '#f59e0b', alert: stats.pendingTrainers > 0 },
        { icon: <ClipboardList size={24} />, label: 'Pedidos Pendentes', value: stats.pendingRequests, color: '#ef4444', alert: stats.pendingRequests > 0 },
    ];
    ...
    return (
        <div className="admin-dashboard animate-fade">
            ...
            <style jsx>{`
                ...
                .modal-content { width: 90%; max-width: 800px; max-height: 80vh; padding: 2rem; border-radius: 1rem; background: var(--bg-primary); display: flex; flex-direction: column; overflow: hidden; }
                .modal-header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem; }
                .close-btn { background: none; border: none; font-size: 1.2rem; cursor: pointer; color: var(--text-secondary); }
                
                .tabs { display: flex; gap: 1rem; margin-bottom: 1rem; border-bottom: 1px solid var(--border-color); }
                .tab { background: none; border: none; padding: 0.75rem 1.5rem; cursor: pointer; color: var(--text-secondary); border-bottom: 2px solid transparent; font-weight: 500; }
                ...
                .user-table th { color: var(--text-secondary); font-weight: 600; font-size: 0.9rem; }
